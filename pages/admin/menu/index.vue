        ...
        <div class="card-body">
               ...
               <div class="col-md-6 col-lg-6">
                  <div class="input-group-prepend">
                    <nuxt-link :to="{name: 'admin-menu-create'}" class="btn btn-info btn-sm" style="padding-top: 8px;"><i
                        class="fa fa-plus-circle"></i> Add New Menu</nuxt-link>
                  </div>
                </div>
          ...
          <b-table striped bordered hover :items="menus" :fields="fields" show-empty>
              ...
              <template v-slot:cell(actions)="row">
                <b-button :to="{name: 'admin-menu-edit-id', params: {id: row.item.id}}" variant="success" size="sm">
                  <i class="fas fa-edit"></i>
                </b-button>
                <b-button variant="danger" size="sm" @click="deleteMenu(row.item.id)">
