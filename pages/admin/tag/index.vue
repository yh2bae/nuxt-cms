    ...
    <section class="content">
      <div class="card card-outline card-info">
        ...
        <div class="card-body">
               ...
               <div class="col-md-6 col-lg-6">
                  <div class="input-group-prepend">
                    <nuxt-link :to="{name: 'admin-tag-create'}" class="btn btn-info btn-sm" style="padding-top: 8px;"><i
                        class="fa fa-plus-circle"></i> Add New Tag</nuxt-link>
                  </div>
                </div>
          ...
          <!-- table -->
          <b-table bordered hover :items="tags" :fields="fields" :responsive="sm" :sort-by.sync="sortBy" show-empty>
              <template v-slot:cell(index)="data">
                {{ data.index + 1 }} .
              </template>
              <template v-slot:cell(actions)="row">
                <b-button :to="{name: 'admin-tag-edit-id', params: {id: row.item.id}}" variant="success" size="sm">
                  <i class="fas fa-edit"></i>
                </b-button>
                <b-button variant="danger" size="sm" @click="deleteTag(row.item.id)">
