    ...
    <section class="content">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title"><i class="nav-icon fas fa-book-open"></i> Add New Post</h3>
        ...
        <div class="card-body">
          <form @submit.prevent="storePost">
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="post.title" :class="{ 'is-invalid': validation.title }"  placeholder="Enter post title"  class="form-control">
            </div>

            <div class="form-group">
              <label>Category</label>
              <multiselect v-model="post.category_id" :class="{ 'is-invalid': validation.category_id }" :options="categories" label="name" track-by="id" :searchable="true"></multiselect>
            </div>

            <div class="form-group">
              <label>Post Content</label>
              <client-only placeholder="loading...">
                <ckeditor-nuxt v-model="post.content" :config="editorConfig" :class="{ 'is-invalid': validation.content }" />
              </client-only>
            </div>
            ...
            <div class="form-group">
              ...
              <textarea v-model="post.description" class="form-control" rows="3"
                placeholder="Enter description" :class="{ 'is-invalid': validation.description }"></textarea>
            </div>
